...
class CSLockedHeaderViewController: BaseController {
    private lazy var collectionView: UICollectionView = {
        ...
        layout.parallaxHeaderReferenceSize = CGSize(width: self.view.frame.width, height: 56)
        ...
        layout.parallaxHeaderMinimumReferenceSize = CGSize(width: self.view.frame.width, height: 56);
